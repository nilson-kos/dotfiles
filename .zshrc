...
zstyle ':vcs_info:*' formats "%{$fg[red]%}%c%{$fg[red]%}%u%{$reset_color%} [%{$fg[red]%}%b%{$reset_color%}] %{$fg[red]%}%s%{$reset_color%}:%r"
...
prompt="%{$fg[$color]%}%n%{$reset_color%}@%U%{$fg[red]%}%m%{$reset_color%}%u %T %B%~%b "
...
export LSCOLORS=bxdxcbdbbxebedababacad
